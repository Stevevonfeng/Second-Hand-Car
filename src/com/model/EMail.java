...
/**
 * 发送邮件的测试程序(适用qq邮箱) 通过本人的qq邮箱: xxx@qq.com 发送邮件
 * 
 * @author HAOWL
 * 
 */
public class EMail {
	...
	// 发送的邮箱 内部代码只适用qq邮箱
	private static final String USER = "997642276@qq.com";
	// 授权密码 通过QQ邮箱设置->账户->开启POP3/SMTP服务获取授权码
	private static final String PWD = "rxwhdfykmgjlbeba";
	private String[] to;
	...
	public static void ValidationInformation(Users user, String loginemail,int number) {

		EMail mail = new EMail();
		mail.setSubject("SecondHandCar");
		String username = user.getUsername();
		String ynumber = String.valueOf(number);
		String str = "尊敬的" + username + "用户!你好，您的登录验证码是：" + ynumber + "";
		if (user != null) {

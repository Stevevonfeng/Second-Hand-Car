...
<body>
	...
	<div class="header">
		<div class="container">
			<div class="header-info navbar-left wow fadeInLeft animated" data-wow-delay=".5s" style="visibility: visible; -webkit-animation-delay: .5s;">
				<p>Information Service : 000-1234-1234</p>
			</div>				
		...
		<nav class="navbar navbar-default">
			<div class="container">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand wow bounceIn animated" data-wow-delay=".5s" style="visibility: visible; -webkit-animation-delay: .5s;" href="index.html">Ramble</a></h1>
				</div>
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav navbar-left">
						...
						<li class="hvr-bounce-to-bottom"><a href="#gallery" class="scroll">Gallery</a></li>
	...
	<div class="about" id="about">
		<div class="container">
			<h3 class="title">Welcome to our page</h3>
	...
	<div class="special"> 
		<div class="container">
			<div class="col-md-5 special-grids wow fadeInLeft animated" data-wow-delay=".5s" style="visibility: visible; -webkit-animation-delay: .5s;">
				<h3 class="title">Our Specialization</h3>

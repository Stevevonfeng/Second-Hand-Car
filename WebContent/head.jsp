			...
			<div class="container">
				<div class="row">
					<div class="col-sm-3 col-md-2">
						<div class="logo">
							<a href="home.jsp"><img src="assets/images/logo.png"
								alt="image" /></a>
						</div>
					</div>
					<div class="col-sm-9 col-md-10">
						<div class="header_info">
							...
							<div class="login_btn">
								<a <c:if test="${user==null }">href="#loginform" </c:if>
									class="btn btn-xs uppercase" data-toggle="modal"
									data-dismiss="modal"><span id="IsLogin">登录 /注册</span></a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="container">
							...
							<li class="dropdown"><a href="#" data-toggle="dropdown"
								aria-haspopup="true" aria-expanded="false"><i
									class="fa fa-user-circle" aria-hidden="true"></i> <c:if
										test="${user==null }">未登录</c:if>${user.username}<i
									class="fa fa-angle-down" aria-hidden="true"></i></a> <c:if
									test="${user!=null }">
									<ul class="dropdown-menu">
										...
										<li><a href="#loginform" data-toggle="modal"
											data-dismiss="modal">切换账号</a></li>
										<li><a
											href="User?act=SignOut&username=${user.getUsername()}">退出登录</a></li>
									</ul>
								</c:if></li>
						</ul>
					</div>
				...
				<div class="collapse navbar-collapse" id="navigation">
					<ul class="nav navbar-nav">
						...
						<li><a href="list?act=ListShow&username=${param.username }">库存</a>
						</li>
						<li><a
							href="dealers?act=displaydealers&username=${param.username }">经销商</a>
						</li>
						<li>
						<li><a href="compare.jsp">车辆比较</a></li>

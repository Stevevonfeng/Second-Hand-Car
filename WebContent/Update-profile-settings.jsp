						...
						<form action="User" method="get">
							...
							<div class="form-group">
								<label class="control-label">旧密码</label>
								 <input
									class="form-control white_bg" name="ypassword" value="${user.getUserpassword()}" 
									type="text">
							</div>
							<div class="form-group">
								...
								<input type="hidden" name="act" value="Update"  />
								<input
									class="form-control white_bg" name="userpassword" type="password">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<button type="submit" class="btn">
									Save Changes <span class="angle_arrow"><i
